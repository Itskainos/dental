      ...
      <div className="container mx-auto px-6 md:px-12">
        ...
        >
          ...
          <motion.div variants={cardVariants} className="bento-card p-10 md:col-span-2 relative overflow-hidden group flex flex-col justify-end bg-white">
            <div className="absolute top-10 right-10 w-16 h-16 bg-soft-pearl rounded-full flex items-center justify-center text-sage-green group-hover:scale-110 transition-transform duration-500">
          ...
          <motion.div variants={cardVariants} className="bento-card p-10 md:col-span-2 relative overflow-hidden group flex flex-col justify-end bg-deep-charcoal">
            <div className="absolute top-10 left-10 w-16 h-16 bg-white/10 rounded-full flex items-center justify-center text-soft-pearl group-hover:scale-110 transition-transform duration-500">
